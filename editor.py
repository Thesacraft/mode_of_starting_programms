                        ...
                        if (mode_edit == "delete"):
                            ...
                            while True:
                                with open("json/" + file) as json_file:
                                    ...
                                    while True:
                                        key = input(
                                            "Enter the name of the programm if it should bring up the webbrowser please type webbrowser(change to change the mode)!")
                                        if not key == "change" and not key == "exit" and not key in json_object:
                                            ...
                                            print(
                                                "You can't input a name like change or exit and their cannot be the same programm twice!")
                                    if break_again:
                                        break

                                    programm_path = input(
                                        "Enter the path of the programm if it should bring up the webbrowser please enter the full adress it should bring up!(change to change the mode)")
